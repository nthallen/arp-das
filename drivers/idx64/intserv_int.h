...
extern void expint_init( int coid, int8_t code, int value );
...
extern void expint_attach( /* pid_t who, */ const char *cardID, unsigned short address,
					  int region, pid_t proxy, IntSrv_reply *rep );
extern void expint_detach( /* pid_t who, */ const char *cardID, IntSrv_reply *rep );
